...
public final class ServerConstants {
  ...
  /*  //paths
    ...
    public static final String ERROR_404 = "error-404.html";
    public static final String ERROR_404_ABSOLUTE_PATH = PROJECT_DIRECTORY + "\\src\\main\\java\\app\\casebook\\resources\\assets\\html\\error-404.html";
    ...
    public static final String LOGIN = "html/login" + DOT + HTML_CONTENT_TYPE_STRING;
    public static final String LOGOUT = "logout";
    public static final String REGISTER = "html/register" + DOT + HTML_CONTENT_TYPE_STRING;
    public static final String USERS_PROFILE_PAGE = "users/profile";
    public static final String HOME = "home";
    public static final String PROFILE = "users";
    public static final String SERVER_PNG = SERVER + PNG_EXTENSION;
    private static final String LOGGED = "logged";
    public static final String PATH_TO_PROFILE_PAGE = PROJECT_DIRECTORY + RESOURCE_FOLDER + PAGES + USERS_PROFILE_PAGE +
            DOT + HTML_CONTENT_TYPE_STRING;
    public static final String PATH_TO_HOME_PAGE = PROJECT_DIRECTORY + RESOURCE_FOLDER + PAGES + HOME + "\\" + HOME +
            DOT + HTML_CONTENT_TYPE_STRING;
    public static final String PATH_TO_REGISTER_PAGE = PROJECT_DIRECTORY + RESOURCE_FOLDER + ASSETS + REGISTER;
    public static final String PATH_TO_LOGIN_PAGE = PROJECT_DIRECTORY + RESOURCE_FOLDER + ASSETS + LOGIN;
