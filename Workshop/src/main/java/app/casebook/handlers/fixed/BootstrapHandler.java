...
import static main.java.app.casebook.utilities.ApplicationConstants.BOOTSTRAP_CSS_PATH;
...
public class BootstrapHandler extends BaseHandler {
    ...
    @Get(route = "/css/bootstrap.min.css")
    public IHttpResponse buildResponse(IHttpRequest request, IHttpResponse response) {
        return super.handleEvent(request, response, Response.RESPONSE_OK, ContentType.CSS, BOOTSTRAP_CSS_PATH);
    }
}
