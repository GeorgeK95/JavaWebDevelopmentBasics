...
public abstract class BaseRepository {
    ...
    private static final String CASEBOOK_PERSISTENCE_UNIT = "casebook_db";
    ...
    protected <T> List<T> getResults(String findAllQuery, Class<T> clazz) {
        return this.entityManager.createNativeQuery(findAllQuery, clazz).getResultList();
    }
}