...
public class HttpResponse implements IHttpResponse {
    ...
    public byte[] getBytes() {
        //whole response (ResponseLine + Headers + Content) as byte array.
    ...
    public void addCookie(String cookie, String value) {
        String fullCookieString = cookie + EQUAL_SPLITTER + value;
//        String path = fullCookieString + "; Path=/";
        if (!this.headers.containsKey(SET_COOKIE)) {
            this.headers.put(SET_COOKIE, SET_COOKIE + fullCookieString);
        } else {
